      ...
      <div className="min-vh-100 bg-light">
        ...
        >
          <div className="container">
            <h1 className="text-white text-center mb-0">Tech Talk Gallery</h1>
          </div>
        </div>
              ...
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    &ldquo;Exploring the future of AI and its impact on society&rdquo;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    &ldquo;Modern web development practices and trends&rdquo;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    &ldquo;Protecting digital assets in an evolving threat landscape&rdquo;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="card h-100 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    &ldquo;Leveraging cloud technologies for scalable solutions&rdquo;
                  </p>
                </div>
              </div>
            </div>
