                ...
                <div className="row g-4">
                  <div className="col-md-4">
                    <div className="card border-0 rounded-4 overflow-hidden shadow">
                      <img src="https://i.imgur.com/RCbVBEl.jpg" className="img-fluid" alt="Coding Contest" />
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card border-0 rounded-4 overflow-hidden shadow">
                      <img src="https://i.imgur.com/c3XmaeB.jpg" className="img-fluid" alt="Award Ceremony" />
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card border-0 rounded-4 overflow-hidden shadow">
                      <img src="https://i.imgur.com/yIGcX6H.jpg" className="img-fluid" alt="Group Photo" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="content mt-4">
                ...
                <div className="row g-4 mt-3">
                  <div className="col-md-6">
                    <div className="card border-0 rounded-4 overflow-hidden shadow">
                      <img src="https://i.imgur.com/pHl1znH.jpg" className="img-fluid" alt="Hackathon Poster" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="card border-0 rounded-4 overflow-hidden shadow">
                      <img src="https://i.imgur.com/1NZwX4r.jpg" className="img-fluid" alt="Hackathon Banner" />
                    </div>
                  </div>
                </div>
              </div>
